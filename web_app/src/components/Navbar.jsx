    ...
    <header className="bg-console-panel border-b border-console-line sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          {/* Connection Status */}
          <div className={`h-8 px-2.5 rounded-md text-[10px] font-bold uppercase tracking-wider flex items-center gap-1.5 border ${
            isOnline
          ...
          <button
            ...
            className="h-8 px-3 bg-console-raised hover:bg-console-line border border-console-line rounded-md text-[11px] font-bold text-ink flex items-center gap-1.5 transition-colors"
          >
            {activeMode === 'student' ? (
              <>
          ...
          <button
            onClick={onExitApp}
            className="h-8 px-2.5 bg-bad/10 hover:bg-bad/20 border border-bad/25 text-bad rounded-md text-[11px] font-bold flex items-center gap-1.5 transition-colors"
